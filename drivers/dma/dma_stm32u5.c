...
//	  LL_DMA_DisconnectNextLinkNode(&Node_GPDMA1_Channel0, LL_DMA_CLLR_OFFSET5);
	  LL_DMA_SetLinkedListBaseAddr(dma, dma_stm32_id_to_stream(id), (uint32_t)&Node_GPDMA1_Channel0);

	  DMA_InitLinkedListStruct.Priority = LL_DMA_LOW_PRIORITY_LOW_WEIGHT;
	  DMA_InitLinkedListStruct.LinkStepMode = LL_DMA_LSM_FULL_EXECUTION;
	  DMA_InitLinkedListStruct.LinkAllocatedPort = LL_DMA_DEST_ALLOCATED_PORT0;
